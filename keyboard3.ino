...
{  
    ...
    if(x_or_y)
    {
        if(right)
        {
            current_x = x-fastAnalogRead(A5);
        }
        else
        {
            current_x = x-fastAnalogRead(25);
        }        
        //SerialUSB.print("current_x : ");SerialUSB.println(current_x);
    ...
    else
    {
        if(right)
        {
            current_y = y-fastAnalogRead(25);
        }
        else
        {
            current_y = y-fastAnalogRead(A5);
        }        
        //SerialUSB.print("current_y : ");SerialUSB.println(current_x);
        ...
        {
            Keyboard.press(keyMod[nbKeys-1]); key3[nbKeys-1]=true; }
        else
        {
